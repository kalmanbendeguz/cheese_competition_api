module.exports = async function (req, res, next) {
    try {
        console.log('mw:update_dependencies(product/one/post/mw/update_dependencies)')

        if ('email' in req.body && req.body.email !== res.locals.allowed_judge.email) { // =if email changes. //req.body.email can be undefined
