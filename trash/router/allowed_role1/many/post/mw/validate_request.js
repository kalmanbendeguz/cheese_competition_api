    ...
    try {
        ...
        const validator = Joi.object({
            body: Joi.array().items(
                ...
                })).unique().min(1).required() // minden unique-nál: meggyőződni arról, hogy az object típusokat is mélyen összehasonlítja egymással. ha nem, akkor saját komparátort kell írni mindenhova !!!
        }).unknown(true)
