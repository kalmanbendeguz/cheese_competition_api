module.exports = async function (req, res, next) {
    try {
        ...
        const manufacturer_id = req.user.role === 'competitor' ? req.user._id : req.query.manufacturer_id

        res.locals.filter = {
            ...(req.query._id && { _id: req.query._id }),
            ...(req.query.competition_id && { competition_id: req.query.competition_id }),
            ...
            ...(req.query.maturation_time_type && { maturation_time_type: req.query.maturation_time_type }),
            ...(req.query.maturation_time_quantity && { maturation_time_quantity: req.query.maturation_time_quantity }),
            ...(req.query.maturation_time_unit && { maturation_time_unit: req.query.maturation_time_unit }),
            ...(req.query.milk_type && { milk_type: req.query.milk_type }),
            ...(req.query.product_category_list && { product_category_list: req.query.product_category_list }),
            ...(req.query.approved && { approved: req.query.approved }),
            ...(req.query.approval_type && { approval_type: req.query.approval_type }),
