...
function on_add_picture_button_click(e) {
  ...
  const r = t[0],
    ...
    n = r.querySelector(".picture_input_label");
  (i.disabled = !1),
...
async function update_image_display(e) {
  const t = e.target.parentNode.querySelector(".picture_preview"),
    ...
    n = e.target.parentNode.querySelector(".remove_picture_button"),
    o = e.target.parentNode.querySelector(".picture_input_label");
  if (
