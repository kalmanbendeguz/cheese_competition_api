...
app.get('/export_archived_results_by_counties_table',
    check_authenticated(),
...
app.get('/export_archived_results',
    check_authenticated(),
    get_archived_cheeses(),
    get_archived_scores(),
    get_medals(),
...
app.get('/archived_cheeses_export_cheese_numbers_by_counties_table',
    check_authenticated(),
    get_archived_cheeses(),
    get_users_of_cheeses(),
    archived_cheeses_export_cheese_numbers_by_counties_table()
...
app.get('/archived_cheeses_export_detailed_table',
    check_authenticated(),
    get_archived_cheeses(),
    get_users_of_cheeses(),
...
app.get('/export_results_by_counties_table',
    check_authenticated(),
    get_cheeses(),
    get_scores(),
    get_medals(),
...
app.get('/cheeses_export_cheese_numbers_by_counties_table',
    check_authenticated(),
    get_cheeses(),
    get_users_of_cheeses(),
    cheeses_export_cheese_numbers_by_counties_table()
...
app.get('/cheeses_export_detailed_table',
    check_authenticated(),
    get_cheeses(),
    get_users_of_cheeses(),
    cheeses_export_detailed_table()
...
app.get('/close_competition',
    check_authenticated(),
    set_competition_closed(),
    redirect('/coordination')
)

app.get('/open_competition',
    check_authenticated(),
    set_competition_opened(),
    redirect('/coordination')
)

app.get('/download_announcement',
    check_authenticated(),
    get_cheeses(),
    get_scores(),
...
app.get('/send_rating_summary_emails',
    check_authenticated(),
    get_cheeses(),
...
app.get('/announcement_of_results',
    check_authenticated(),
    get_message_from_cookie(),
    render('announcement_of_results')
)

app.get('/delete_cheese',
    check_authenticated(),
    remove_cheese(),
...
app.get('/authenticated_message',
    check_message_authenticated(),
    get_message_from_cookie(),
    render('authenticated_message')
)

app.get('/unauthenticated_message',
