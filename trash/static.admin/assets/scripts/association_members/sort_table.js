...
const lexicographic_listener = (e) => sortTable(Array.from(e.target.parentNode.children).indexOf(e.target), 'association_members_table', 'lexicographic')
const numeric_listener = (e) => sortTable(Array.from(e.target.parentNode.children).indexOf(e.target), 'association_members_table', 'numeric')
