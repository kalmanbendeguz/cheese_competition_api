...
const lexicographic_listener = (e) => sortTable(Array.from(e.target.parentNode.children).indexOf(e.target), 'view_unpaid_cheeses_table', 'lexicographic')
const numeric_listener = (e) => sortTable(Array.from(e.target.parentNode.children).indexOf(e.target), 'view_unpaid_cheeses_table', 'numeric')
