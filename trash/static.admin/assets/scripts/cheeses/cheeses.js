const delete_cheese_forms = document.querySelectorAll(
  "form[class=delete_cheese_form]"
);
...
const take_cheese_forms = document.querySelectorAll(
  "form[class=take_cheese_form]"
);
