...
milkTypeRadioButtons.forEach(radioButton => radioButton.addEventListener("change", onMilkTypeRadioButtonChange))
...
maturationTimeRadioButtons.forEach(radioButton => radioButton.addEventListener("change", onMaturationTimeRadioButtonChange))
...
milkTypeSelects.forEach(milkTypeSelect => milkTypeSelect.addEventListener('focus', onMilkTypeSelectFocus))
milkTypeSelects.forEach(milkTypeSelect => milkTypeSelect.addEventListener('focusout', onMilkTypeSelectFocusOut))
