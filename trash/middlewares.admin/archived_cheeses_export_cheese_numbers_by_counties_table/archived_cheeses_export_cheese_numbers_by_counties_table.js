const archived_cheeses_export_cheese_numbers_by_counties_table = function() {
    
    return async function(req, res, next) {
        console.log('archived_cheeses_export_cheese_numbers_by_counties_table')
        ...
        counties.unshift({ county: 'Megye', cheese_number: 'Nevezett termékek száma'})

        const XLSX = require("xlsx")
        
        let worksheet = XLSX.utils.json_to_sheet(counties, { header: ["county", "cheese_number"], skipHeader: true})

        let workbook = XLSX.utils.book_new()

        XLSX.utils.book_append_sheet(workbook, worksheet, "archivalt_termekek_megyenkent")
        ...
        res.writeHead(
            ...
            [
                ...
                ['Content-Disposition', `attachment; filename="archivalt_termekek_megyenkent.xlsx"`]
            ]
        )
        //return res.download(id_pairs_file_path)
...
module.exports = archived_cheeses_export_cheese_numbers_by_counties_table