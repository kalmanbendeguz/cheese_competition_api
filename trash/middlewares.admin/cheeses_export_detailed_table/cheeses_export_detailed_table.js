const cheeses_export_detailed_table = function () {
  return async function (req, res, next) {
    console.log("cheeses_export_detailed_table");
    ...
    let worksheet = XLSX.utils.json_to_sheet(res.locals.cheeses, {
      header: [
        "public_id",
        "secret_id",
        "product_name",
    ...
    res.writeHead(200, [
      ...
      [
        "Content-Disposition",
        `attachment; filename="nevezett_termekek_reszletes.xlsx"`,
      ],
    ]);
    //return res.download(id_pairs_file_path)
...
module.exports = cheeses_export_detailed_table;
