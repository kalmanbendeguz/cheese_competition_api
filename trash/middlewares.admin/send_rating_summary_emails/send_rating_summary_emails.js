    ...
    for await (let cheese of res.locals.cheeses) {
      ...
      if (cheese.average_score >= 84.5) {
        ...
        if (cheese.average_score <= 100 && cheese.average_score >= 94.5) {
          ...
          cheese.average_score < 94.5 &&
          cheese.average_score >= 89.5
        ) {
          qualification = "EZÜST";
        } else if (
          cheese.average_score < 89.5 &&
          cheese.average_score >= 84.5
        ) {
          qualification = "BRONZ";
        }
      ...
      const options = {
        ...
        html: `
                ...
                <br>${dictionary[cheese.product_category_list[0]]} / ${
          dictionary[
            cheese.product_category_list[
              cheese.product_category_list.length - 1
            ]
          ]
        } kategóriában nevezett,
