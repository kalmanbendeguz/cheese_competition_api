const get_rating = function() {
    ...
    return async function(req, res, next) {
        ...
        res.locals.rating = 
            await Rating_Model.findOne({ secret_id: req.query.secret_id, judge_email: req.query.judge_email })
        
        if(res.locals.rating) return next()

        req.app.push_cookie_array(req, res, 'errors', 'Ez az értékelés nem létezik.')
