const export_archived_results = function () {

    return async function (req, res, next) {
        console.log('export_archived_results')
        ...
        for(let i=0; i < res.locals.cheeses.length; ++i){
            ...
            if(isNaN(res.locals.cheeses[i].average_score)) res.locals.cheeses[i].average_score = ""
            ...
            res.locals.cheeses[i] = { 
                ...
                "product_category_list_string": res.locals.cheeses[i].product_category_list_string,
                "maturation_time_string": res.locals.cheeses[i].maturation_time_string,
                "maturation_time_days_equal": res.locals.cheeses[i].maturation_time_days_equal, 
        ...
        res.writeHead(
            ...
            [
                ...
                ['Content-Disposition', `attachment; filename="archivalt_eredmenyek_reszletes.xlsx"`]
            ]
        )
        //return res.download(id_pairs_file_path)
...
module.exports = export_archived_results