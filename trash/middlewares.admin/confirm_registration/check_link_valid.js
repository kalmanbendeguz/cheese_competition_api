const check_link_valid = function () {
  ...
  return async function (req, res, next) {
    ...
    res.locals.temporary_registration =
      await Admin_Temporary_Registration_Model.findOne({
        confirm_string: req.query.confirm_id,
      });
    ...
    req.app.push_cookie_array(
      ...
      res,
      "errors",
      `Ezt a megerősítő linket már felhasználták, vagy a hozzá kapcsolódó regisztrációt felülírták.`
    );
