const get_temporary_rating = function() {
    ...
    return async function(req, res, next) {
        ...
        res.locals.temporary_rating = 
            await Temporary_Rating_Model.findOne({ confirm_string: req.body.confirm_link_identifier })
        
        if(res.locals.temporary_rating) return next()

        req.app.push_cookie_array(req, res, 'errors', 'Ezzel az azonosítóval ideiglenes értékelés nem létezik.')
