const check_restore_id_valid = async function (req, res, next) {
    try {
        ...
        res.locals.active_password_reset =
            await req.app.models.judge_active_password_reset.findOne({ restore_id: req.body.restore_id })
        ...
        req.app.set_session_context(
            req.session,
            'errors',
            req.app.locals.dict[res.locals.lang].restore_password_id_invalid_since_opening
        )
