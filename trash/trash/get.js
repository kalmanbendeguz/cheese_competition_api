module.exports = async function (req, res, next) {
  try {
    ...
    const product = new Product_Model({
      ...
      milk_type: "tehentej",
      product_category_list: ["erlelt_sajt", "finom_sajt", "edd_meg_legyszi"],
      product_description:
        "Nagyon finom, tehéntejből készült sajt amit a saját, családi gazdaságunkban készítettünk.",
    });
      ...
      aspects: [
        {
          ...
          comment:
            "Ez igen, annyira finom hogy nagyon! Köszönjük a nevezést! Nagyon jóóó.",
        },
        {
          title: "Szag",
          score: 69,
          ...
          comment:
            "Hát ezt büntetni kellene. Kihívtam a vegyi hatástalanító csapatot. Remélem megoldják a helyzetet.",
        },
      ],
      overall_impression:
        "Valami akármi finom volt összességében hát nem is tudom, az a lényeg hogy remélem kijött a minimum karakterszám.",
      table_leader: true,
    });
