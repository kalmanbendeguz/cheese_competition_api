...
!(function (t, e) {
  ...
  class Mi extends B {
    ...
    show(t) {
      this._isShown ||
        ...
        j.trigger(this._element, Li, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
  ...
  class dn extends B {
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(en, nn), (this.tip = e), this.tip
      );
    }
    setContent(t) {
        ...
        return o(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = Xi(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
  ...
  class Ln extends B {
    ...
    _activate(t, e, i) {
      ...
      n && s ? (n.classList.remove(On), this._queueCallback(o, t, !0)) : o();
    }
    _transitionComplete(t, e, i) {
      ...
      if (
        ...
        e && V.find(".dropdown-toggle", e).forEach((t) => t.classList.add(An)),
