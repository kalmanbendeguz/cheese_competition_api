...
const authorizer = require('../../../authorizers/resources/competition')
const filter_validator = require('../../../validators/requests/api/resources/competition/filter')
const content_validator = require('../../../validators/requests/api/resources/competition/content')
