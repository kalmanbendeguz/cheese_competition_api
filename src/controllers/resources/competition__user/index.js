const Model = require('../../../models/Competition__User')
const authorizer = require('../../../authorizers/resources/competition__user')
const filter_validator = require('../../../validators/requests/api/resources/competition__user/filter')
const content_validator = require('../../../validators/requests/api/resources/competition__user/content')
