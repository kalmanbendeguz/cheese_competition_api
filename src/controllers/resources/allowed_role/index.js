const Model = require('../../../models/Allowed_Role')
const authorizer = require('../../../authorizers/resources/allowed_role')
const filter_validator = require('../../../validators/requests/api/resources/allowed_role/filter')
const content_validator = require('../../../validators/requests/api/resources/allowed_role/content')
