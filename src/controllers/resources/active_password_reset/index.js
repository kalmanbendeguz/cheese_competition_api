...
const authorizer = require('../../../authorizers/resources/active_password_reset')
const filter_validator = require('../../../validators/requests/api/resources/active_password_reset/filter')
const content_validator = require('../../../validators/requests/api/resources/active_password_reset/content')
