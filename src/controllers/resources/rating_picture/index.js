const Model = require('../../../models/Rating_Picture')
const authorizer = require('../../../authorizers/resources/rating_picture')
const filter_validator = require('../../../validators/requests/api/resources/rating_picture/filter')
const content_validator = require('../../../validators/requests/api/resources/rating_picture/content')
...
const multer = require('../../../middlewares/api/resources/rating_picture/multer')
const req_files_to_req_body_content = require('../../../middlewares/api/resources/rating_picture/req_files_to_req_body_content')

controller.middlewares = {}
// MW gets: req
controller.middlewares.post = [
    multer,
    req_files_to_req_body_content,
    post(content_validator, controller.transaction.create)
]
controller.middlewares.get = get(filter_validator, controller.transaction.find)
controller.middlewares.put = [
    multer,
    req_files_to_req_body_content,
    put(filter_validator, content_validator, controller.transaction.update)
]
