const create_one = async (fields, session, create_one_document) => {

    // Check dependencies
    // Dependencies: [Product, Competition, Entry_Fee_Payment, User]
    

    // Create document
    // Generate generated fields and set default values

    // const create_one_document = async (model, fields, validator) 
    const document = await create_one_document(fields) // model and validator are added by the controller
    // Save document
